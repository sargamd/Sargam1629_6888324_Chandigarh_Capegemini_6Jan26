...
namespace BookPublisherCodeFIrst.Controllers
{
    public class BookModelsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("BookId,Title,Author,Price,Category,Publisher,PublishedYear")] BookModel bookModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("BookId,Title,Author,Price,Category,Publisher,PublishedYear")] BookModel bookModel)
        {
