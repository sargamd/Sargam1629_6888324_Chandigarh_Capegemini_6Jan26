...
namespace DBFirstMVC.Controllers
{
    ...
    {
        private readonly LibrarydbMvcContext _context;

        public BooksController(LibrarydbMvcContext context)
        {
            _context = context;
        }
        ...
        {
            var librarydbMvcContext = _context.Books.Include(b => b.Author);
            return View(await librarydbMvcContext.ToListAsync());
        }
