...
description varchar(50),yearsofpayements int,amount double precision,maturityperiod int,
maturityamount double precision,validity int);
...
create table policy_payments(receipno int primary key,
user_id int references user_details(user_id),policy_no varchar(20) references user_policies(policy_no),dateofpayment date,amount double precision,fine double precision);
